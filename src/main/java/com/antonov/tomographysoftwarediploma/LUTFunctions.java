...
/**
* This class contains several static methods that create on-the-fly look-up tables.
*/
public class LUTFunctions
 ...
 public final static short[][] gray2levels()
   {
   short[][] lut = new short[256][3];
   for(short i=0;i<256;i++)
     {
 ...
 public final static short[][] gray4levels()
   {
   short[][] lut = new short[256][3];
   for(short i=0;i<256;i++)
     {
 ...
 public final static short[][] gray8levels()
   {
   short[][] lut = new short[256][3];
   for(short i=0;i<256;i++)
     {
 ...
 public final static short[][] gray16levels()
   {
   short[][] lut = new short[256][3];
   for(short i=0;i<256;i++)
     {
 ...
 /** The thirty-two-levels gray lut */
 public final static short[][] gray32levels()
   {
   short[][] lut = new short[256][3];
   for(short i=0;i<256;i++)
     {
 ...
 public final static short[][] gray64levels()
   {
   short[][] lut = new short[256][3];
   for(short i=0;i<256;i++)
     {
 ...
 /** The hundred-twenty-eight-levels gray lut. Are we bored with gray yet? */
 public final static short[][] gray128levels()
   {
   short[][] lut = new short[256][3];
   for(short i=0;i<256;i++)
     {
 ...
 public final static short[][] hue_rgb()
   ...
   for(short i=0;i<43;i++)
     {
     lut[i][0] = (short)r; lut[i][1] = (short)g; lut[i][2] = (short)b;
     g += 5.9;
     }
   r = 255; g = 255; b = 0;
